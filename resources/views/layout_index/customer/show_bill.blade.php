...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('adminlte2/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
    ...
    <div>
        ...
        <section class="invoice">
                ...
                <div class="col-xs-12">
                    <h2 class="page-header">
                        ...
                        <small class="pull-right">Date:
                            {{ date('d/m/Y ', strtotime($point_purchase->created_at)) }}</small>
                    </h2>
                </div>
                <!-- /.col -->
            </div class="invoice">
            ...
            <div class="row no-print">
                <div class="col-xs-12">
                    <a href="#" class="btn btn-default pull-right" onclick="myFunction()"><i class="fa fa-print"></i> Print</a>
                </div>
            </div>
        </section>
        <!-- /.content -->
