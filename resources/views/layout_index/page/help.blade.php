    ...
    <div class="nk-blog-fullwidth">
            ...
            <div class="row vertical-gap">
                ...
                <div class="col-md-4 col-lg-3">
                    <div class="nk-post-by">
                        <img src="{{ asset('assets/images/avatar-1.jpg') }}" alt="Hitman" class="rounded-circle" width="60">
                        by <a href="#">Hitman</a>
        ...
        <div class="nk-blog-post">
            ...
            <div class="row vertical-gap">
                ...
                <div class="col-md-4 col-lg-3">
                    <div class="nk-post-by">
                        <img src="{{ asset('assets/images/avatar-2.jpg') }}" alt="Witch Murder" class="rounded-circle" width="60">
        ...
        <div class="nk-blog-post">
            ...
            <div class="row vertical-gap">
                ...
                <div class="col-md-4 col-lg-3">
                    <div class="nk-post-by">
                        <img src="{{ asset('assets/images/avatar-3.jpg') }}" alt="Wolfenstein" class="rounded-circle" width="60">
