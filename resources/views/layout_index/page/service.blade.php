...
<style>
    ...
    <div class="nk-main">
        ...
        <div class="container">
            ...
            <div class="col-lg-12">
                <p> <b>1. GAMEMOBILE.IO </b> is a website that supports users to recharge games, pay for mobile game apps like iOS
                ...
                <p><b>2. Definition :</b><br>
                    ...
                    - Account: Your account means valid registration with GAMEMOBILE for your convenience by using the
                    service
                    available on GAMEMOBILE. <br>
                    - Buyer: Means a person who makes a purchase on GAMEMOBILE. <br>
                    - Gift Card: A card with a stored value available for reloading on GAMEMOBILE. <br>
                    ...
                    - Services: Provided by GAMEMOBILE include: iTunes Gift Card / CH Play Gift Card / in-game currencies.
                </p>
                <p><b>3.Compliance requirements : </b><br>
                    ...
                    - GAMEMOBILE.IO has the right to notify these suspected infringing activities to the authorities or a
                    third
                    party if deemed necessary. GAMEMOBILE.IO will also cooperate with functional legal authorities to assist
                    in
                    the investigation and prosecution of illegal activities according to regulations. <br>
                    - If the Customer wants to report any actions that violate these terms, please contact GAMEMOBILE.IO via
                    email: contact@gamemobile.io or through other GAMEMOBILE.IO contact channels such as online or phone
                    support. <br>
                    - In order to be able to support customers quickly and conveniently, when registering a member account
                    at
                    GAMEMOBILE.IO or placing an order without using a GAMEMOBILE.IO account, please register the correct
                    information. the following information : <br>
                    + Customer name <br>
                    + Contact phone number and email</p>
               <p><b>4. Service disclaimer : </b><br>
                - GAMEMOBILE.IO provides services to customers through a third party with Internet transmission service, when
                the following cases occur: Internet connection loss, power failure, natural disaster, flood, and other
                objective factors beyond control. control of GAMEMOBILE.IO results in a delay or failure to use the
                GAMEMOBILE.IO services. In such cases, GAMEMOBILE.IO does not warrant that the system or the Service will
                operate without interruption. However, to the extent possible GAMEMOBILE.IO will attempt to fix the problem. </p>
               <p><b>5. Policy on payment, transaction status and product receipt : </b><br>
                a. Payment <br>
                - POINTGIFT is the currency converted from all deposit methods on GAMEMOBILE <br>
                - To top up POINTGIFT via GAMEMOBILE account, with a valid deposit form, after selecting the amount of
                ...
                POINTGIFT balance, this balance will remain in your GAMEMOBILE.IO account and be saved for future
                ...
                bank. <br>
                - GAMEMOBILE.IO. shall, in its sole and absolute discretion, cancel any of your payment requests without any
                reason whatsoever. <br>
                - GAMEMOBILE.IO. reserves the right to change or modify or remove the payment methods available on the
                ...
                - Pending: GAMEMOBILE.IO is a semi-automatic system, except for scratch card payment, credit card top-up,
                ...
                GAMEMOBILE to contact the supplier soon to complete the purchase or will proceed with a full refund pay. <br>
                ...
                - GAMEMOBILE will refund 100% if: <br>
               ...
               <p><b>6. Limitation of Liability : </b><br>
                - GAMEMOBILE.IO will not bear any responsibility for the consequences of unauthorized access or modification
                ...
                - After making successful transactions at GAMEMOBILE.IO, customers must be responsible for preserving
                personal account information, transaction information, products ordered at GAMEMOBILE.IO. We will not be
                ...
                recharge card and send it to email contact@gamemobile.iofor support staff to analyze errors and provide
                customer support plans. In this case, GAMEMOBILE needs normal processing time from 24 - 96 hours in working
                ...
                - For the catalog of foreign online game products, the number of products is very large, GAMEMOBILE is not a
                card sales partner of these game publishers. Some products may be changed by the issuer of the recharge
                card, but GAMEMOBILE does not receive information, so it cannot be updated immediately. Therefore, customers
                need to update exactly what type of card they need to load before buying a top-up card. GAMEMOBILE will not
                be responsible in this case. <br>
                - In addition, GAMEMOBILE.IO is not responsible in case the server is damaged by Trojan viruses. - As a
                condition of using the GAMEMOBILE.IO system, the Customer agrees that GAMEMOBILE.IO will not be liable to
                you for objective damages that GAMEMOBILE.IO cannot control. - We are not responsible for your incorrect
               ...
               <p><b>7. Access to password-protected </b>areas Only those registered to use the service legally can access and use
                the password-protected areas of the GAMEMOBILE.IO system. Individuals/organizations who intentionally
                intrude into this area without the consent of the registrant to use or the permission of GAMEMOBILE.IO may
               ...
               <p><b>8. Termination of use : </b><br>
                a. GAMEMOBILE.IO reserves the right to temporarily suspend or permanently terminate Customer's use of
                GAMEMOBILE.IO and does not bear any responsibility to Customer and third parties in the following cases: <br>
                - At Customer's request: When Customer does not want to use GAMEMOBILE.IO, Customer can notify support,
                GAMEMOBILE.IO will confirm Customer's request and lock Customer's account. <br>
                - GAMEMOBILE.IO will permanently terminate the Customer's use of the service if the Customer commits frauds,
                ...
                GAMEMOBILE.IO system - At the request of competent legal authorities. <br>
                - In the event of a dispute, complaint, confusion, GAMEMOBILE.IO also has the right to suspend the Service
                account or block a part of the money in the account to serve the settlement of disputes and complaints.
                - Other cases: GAMEMOBILE.IO will notify Customer in advance by one of the following means: phone, email,
                ...
                suspicious transactions, GAMEMOBILE will temporarily freeze the account and make a request to verify the
                ...
                reverse the transaction, GAMEMOBILE will make the refund to the account owner. - Verifying may cause
               ...
               <p><b>9. Mandatory Terms : </b><br>
                GAMEMOBILE.IO will not be responsible for any damages related to the interests of customers. Customers in
                the following cases: <br>
                - For the foreign online game product catalog, the number of products is very large, GAMEMOBILE is not a
                card sales partner of these game publishers. Some products may be changed by the issuer of the recharge
                card, but GAMEMOBILE does not receive information, so it cannot be updated immediately. Therefore, customers
                need to update exactly what type of card they need to load before buying a top-up card. GAMEMOBILE will not
                be responsible in this case. <br>
                ...
                log out of the following account when making deposit transactions / placing orders at GAMEMOBILE, revealing
               ...
               <p><b>10. Disclosure of information : </b><br>
                ...
                - However, GAMEMOBILE.IO may have to disclose personal information of customers in accordance with
                applicable laws; person or entity pursuant to any government directive or court order. <br>
                - GAMEMOBILE.IO absolutely does not disclose customer personal information to any other party without
                notifying the customer in advance.</p>

               <p><b>11. Dispute Regulation GAMEMOBILE.IO</b> will resolve disputes based on the information the Customer has
                provided and updated.</p>

               <p><b>12. Rights and Responsibilities of GAMEMOBILE.IO </b><br>
                - GAMEMOBILE.IO is responsible for working with 3rd party service providers, payment gateways to enhance
                convenience and protect Buyers and Sellers from financial risks from Internet transactions. <br>
                - GAMEMOBILE.IO is responsible for working with 3rd parties providing hosting and security services,
                designing websites to enhance the ease of use of the website and the most secure customer information. <br>
                - In the process of using the service on GAMEMOBILE.IO, there will inevitably be system errors, making it
                difficult for customers to recharge their GAMEMOBILE account or make other payments on GAMEMOBILE,
                GAMEMOBILE is responsible for guiding , assisting customers to complete faulty transactions. <br>
                ...
                account is not credited, then GAMEMOBILE is responsible for checking the notice of the time the card has
                ...
                account. GAMEMOBILE is only responsible for coordinating the information check and disclaiming
               ...
               <p><b>13. Terms of Use</b> is a commitment to agree and accept the provisions of this Service Agreement
                between Customer and GAMEMOBILE when Customer registers and uses GAMEMOBILE.IO. From time to time,
                GAMEMOBILE.IO may change, adjust the contents of the Agreement and update information about changes and
                adjustments on the website http://webgamedemo.xyz without prior notice. for customers. If the Customer
                ...
                the account, service or other permitted activities under the GAMEMOBILE Service Use Agreement. .IO </p> 
            </div>
        </div>
    </div>
@endsection
