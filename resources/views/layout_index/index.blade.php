            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="nk-gap-1"></div>
                        <form action="{{route('login')}}" class="nk-form text-white">
                            ...
                            <div class="row vertical-gap">
                                <div class="col-md-6">
                                    <button class="nk-btn nk-btn-rounded nk-btn-color-white nk-btn-block">Sign In</button>
                                </div>
                                <div class="col-md-6">
                                    <div class="mnt-5">
                                    ...
                                    <div class="mnt-5">
                                        <small><a href="#" data-toggle="modal" data-target="#modalRegister">Not a member? Sign up</a></small>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <form action="{{route('login')}}" class="nk-form text-white">
                                ...
                                <div class="row vertical-gap">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mnt-5">
                                            <small><a href="#">Is a member? Sign In</a></small>
                                        </div>
                                    </div>
                                </div>
                            </form>
