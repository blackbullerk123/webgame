...
class FrontendRepository
{
    ...
    public function getDetailToProduct($id)
    {
        ...
        $product = Product::select('package.product_id', 'package.package_image', 'package.package_name', 'package.package_price', 'package.point_number', 'name', 'os_supported', 'content_1', 'image', 'image_detail')
